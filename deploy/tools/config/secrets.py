...
class ServerSecrets:
    ...
    def __init__(self, server_id: str) -> None:
        ...
        # CI names its own key file in the process env; a local path copied into the file loses.
        if key_file := os.environ.get("SSH_KEY_FILE"):
            self._values["SSH_KEY_FILE"] = key_file
