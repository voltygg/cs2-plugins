...
void SightProbe::Stamp(std::array<PositionSample, MaxSlots>& players, const std::array<AimAngles, MaxSlots>& aims,
...
std::optional<bool> SightProbe::CanSee(int viewer, int target) const
{
