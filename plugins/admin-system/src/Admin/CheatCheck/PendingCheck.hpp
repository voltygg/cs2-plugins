...
struct PendingCheck
{
    ...
    VoltMod::MovementFreeze Freeze;                 // gives the frozen pawn, and only it, its movement back
    VoltMod::Team PriorTeam = VoltMod::Team::None;  // team before force-to-spectator; restored on unfreeze
};
