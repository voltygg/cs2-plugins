...
INSERT INTO admin_groups (name, flags, immunity, inherits)
VALUES ('superadmin', 'z', 100, ARRAY []::TEXT []) ON CONFLICT (name) DO NOTHING;
-- Insert default moderator group
INSERT INTO admin_groups (name, flags, immunity, inherits)
VALUES ('moderator', 'bci', 50, ARRAY []::TEXT []) ON CONFLICT (name) DO NOTHING;
-- Insert schema version
INSERT INTO migrations (version, description)
VALUES (1, 'Initial schema creation') ON CONFLICT (version) DO NOTHING;
